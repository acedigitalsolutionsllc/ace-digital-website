  ...
  return (
    <footer>
      <div className="footer-one-wrapper w-full pt-[130px] bg-white border-t border-slate-100">
          ...
          <div className="w-full">
            ...
            <div className="top-bar w-full flex md:flex-row md:justify-between items-center flex-col space-y-10 md:space-y-0 md:mb-[80px] mb-10">
              ...
              <ul className="flex flex-wrap gap-5 md:gap-14 md:items-center">
                ...
                <li className="font-semibold text-18 hover:text-[#6db305] hover:underline hover:drop-shadow-[0_0_8px_rgba(109,179,5,0.4)] transition-all duration-300 text-paragraph">
            ...
            <div className="w-full py-[80px] border-t border-[#e7e3fa] grid xl:grid-cols-12 md:grid-cols-3 md:gap-10 grid-cols-2 gap-8">
              ...
              <div className="xl:col-span-3">
                ...
                <div className="w-full">
                  ...
                  <p className="font-medium text-paragraph">
                    <a href="mailto:info@aceavatars.com" className="hover:text-[#6db305] transition-colors">
                      info@aceavatars.com
                    </a> <br />
                    <a href="mailto:joe@aceavatars.com" className="hover:text-[#6db305] transition-colors">
                      joe@aceavatars.com
                    </a> <br />
                    <a href="tel:+17252223947" className="hover:text-[#6db305] transition-colors">
                      (725) 222-3947
                    </a>
                  </p>
                </div>
              ...
              <div className="xl:col-span-3">
                <div className="w-full">
                  ...
                  <ul className="flex flex-col space-y-3">
                    <li className="font-medium hover:text-[#6db305] hover:-translate-y-0.5 transition-all duration-300 text-paragraph">
              ...
              <div className="col-span-2 xl:col-span-3 md:col-span-1">
                <div className="w-full mb-10">
                  ...
                  <div className="mb-3">
                    {/* Added Brand Green focus & glow */}
                    <input
                      placeholder="Email Address"
                      className="placeholder:text-paragraph typewriter-input w-full h-[56px] bg-main-gray border border-[#e7e3fa] focus:border-[#6db305] focus:shadow-[0_0_10px_rgba(109,179,5,0.2)] focus:outline-none rounded-full px-[25px] transition-all"
                      type="email"
                    />
                  </div>

                  <Link to="#">
                    {/* Fixed Subscribe Button: Brand Colors + Glow */}
                    <div className="transition-all duration-500 home-two-btn-white-rev group before:bg-white after:bg-white border border-[#094a66] bg-[#094a66] hover:border-[#6db305] hover:shadow-[0_0_20px_rgba(109,179,5,0.4)] rounded-full w-full justify-center px-8 py-3 flex items-center gap-2 mt-2">
        ...
        {/* Bottom Copyright Bar - Gradient changed to Brand Blue */}
        <div
          style={{
            backgroundImage: "linear-gradient( 90deg, #094a66 0%, #f3f4f9 63.23%)",
          }}
        ...
        >
          <div className="h-full mx-auto theme-container w-full px-5 md:px-0">
            <div className="flex items-center justify-between w-full h-full text-xs md:text-base">
              ...
              {/* Back to Top Button - Changed to Brand Colors + Glow */}
              <div className="relative hidden md:block">
                <a
                  ...
                  aria-label="go top"
                  className="w-[45px] h-[45px] rounded-full border-[3px] border-white flex justify-center items-center bg-[#094a66] hover:bg-[#6db305] hover:shadow-[0_0_15px_rgba(109,179,5,0.6)] transition-all duration-300 absolute -top-[55px] shadow-lg"
                >
                  <span>
              ...
              <ul className="items-center hidden md:space-x-6 md:flex">
                <li className="font-medium hover:text-[#6db305] hover:underline hover:drop-shadow-[0_0_5px_rgba(109,179,5,0.4)] transition-all duration-300 text-paragraph cursor-pointer">
