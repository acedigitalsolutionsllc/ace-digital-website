        ...
        >
                ...
                <li key={index} className="w-[90%]">
                  ...
                  {menuItem.subItems ? (
                    <div className="border-b border-gray-100 pb-3 mt-3">
                      <div
                        className="flex justify-between items-center w-full cursor-pointer hover:text-[#6db305] transition-colors duration-300"
                      ...
                      >
                        ...
                        <svg 
                          ...
                          stroke="currentColor" 
                          strokeWidth="3"
                          className={`transition-transform duration-300 text-[#094a66] ${openDropdown === menuItem.title ? "rotate-180" : ""}`}
                        >
                      ...
                      {/* Sub-Items List */}
                      <ul className={`flex flex-col gap-4 pl-4 mt-4 border-l-[3px] border-[#094a66]/20 transition-all duration-300 overflow-hidden ${openDropdown === menuItem.title ? "block" : "hidden"}`}>
                        {menuItem.subItems.map((sub, i) => (
                          <li key={i}>
                            <Link
                              to={sub.href}
                              state={sub.state}
                              className="block text-[15px] font-medium text-paragraph hover:text-[#6db305] transition-colors"
                              onClick={() => {
                                setIsNavActive(false);
                    ...
                    <div className="border-b border-gray-100 pb-3 mt-3">
                      <Link
                        className="block w-full hover:text-[#6db305] transition-colors duration-300"
                        to={menuItem.href}
          ...
          <div className="flex flex-col gap-6 pl-6 mt-10">
            ...
            <a href="tel:+17252223947" className="flex gap-3 items-center group">
              ...
              <span className="text-base font-bold leading-5 tracking-tight text-main-black group-hover:text-[#6db305] transition-colors">
                (725) 222-3947
              </span>
            </a>

            {/* Fixed CTA Button - Color & Glow Updated */}
            <Link to="/contact" onClick={() => setIsNavActive(false)}>
              <div className="transition-all duration-500 home-two-btn-white-rev group before:bg-white after:bg-white border border-[#094a66] bg-[#094a66] hover:border-[#6db305] hover:shadow-[0_0_20px_rgba(109,179,5,0.4)] rounded-full px-8 py-3 flex items-center gap-2 cursor-pointer w-fit">
