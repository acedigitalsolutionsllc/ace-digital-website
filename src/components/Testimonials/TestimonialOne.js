...
export default function TestimonialOne() {
  ...
  return (
    <section id="testimonial" className="relative overflow-hidden bg-white">
      ...
      {/* Modern Gradient Glow Background Effect */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-purple opacity-[0.05] blur-[120px]"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-blue-sass opacity-[0.05] blur-[150px]"></div>
      </div>
      ...
      <div className="testimoial-section-wrapper w-full xl:py-[130px] pt-[60px] pb-[120px] relative z-10 border-t border-slate-100">
        <div className="mx-auto theme-container">
          ...
          <div className="flex flex-col items-center mb-[70px]">
            <span className="inline-block px-5 py-2 mb-5 font-semibold text-xs tracking-widest uppercase text-purple rounded-full bg-purple/10 border border-purple/20">
              Our Testimonials
            </span>
            ...
            <div className="col-span-4">
              <div className="w-full h-[400px] lg:h-[450px] relative rounded-[24px] shadow-2xl border-4 border-white">
                ...
                <div className="absolute -left-5 -bottom-5 sm:left-5 w-[85%] sm:w-auto z-20">
                  <div className="flex justify-between p-2 pl-5 pr-3 bg-white shadow-xl rounded-full items-center border border-slate-100 gap-3">
                ...
                >
                  {testimonials.map((item) => (
                    <SwiperSlide key={item.id}>
                      <div className="w-full bg-white h-full rounded-[24px] py-10 md:py-12 px-6 md:px-12 relative shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 group">
                        ...
                        <div className="absolute right-10 top-10 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
                          <svg width="120" height="120" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-purple">
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="flex items-center space-x-5">
                            <div className="w-[60px] h-[60px] rounded-full overflow-hidden border-2 border-purple p-0.5">
                              <img
                                src={item.image}
                                alt={item.name}
                ...
                <div className="w-full absolute -bottom-[25px] z-20">
                  <div className="flex justify-center w-full">
                    <div className="flex items-center space-x-6 bg-white px-6 py-2 rounded-full shadow-lg border border-slate-100">
                      ...
                      <button
                        type="button"
                        className="w-[35px] h-[35px] rounded-full flex justify-center items-center bg-main-gray hover:bg-purple text-main-black hover:text-white transition-colors duration-300 custom-button-prev"
                      >
                      ...
                      <button
                        type="button"
                        className="w-[35px] h-[35px] rounded-full flex justify-center items-center bg-main-gray hover:bg-purple text-main-black hover:text-white transition-colors duration-300 custom-button-next"
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
