          ...
          <div className="w-full grid grid-cols-6 lg:grid-cols-12 gap-5 sm:gap-[70px]">
            ...
            <div className="flex items-center justify-center col-span-6 relative">
              <img
                ...
                className="max-w-full rounded-[20px] shadow-lg"
              />
              <button
                type="button"
              ...
              >
                <span className="flex size-11 sm:size-[64px] rounded-full justify-center items-center bg-white relative shadow-xl">
                  <span>
                    <svg
                      width="16"
                      height="18"
                  ...
                  <div className="absolute w-full h-full rounded-full h5-play-btn-line1 border border-purple/30"></div>
                  <div className="absolute w-[130%] h-[130%] rounded-full h5-play-btn-line2 border border-purple/20"></div>
                  <div className="absolute w-[160%] h-[160%] rounded-full h5-play-btn-line3 border border-purple/10"></div>
                </span>
              </button>
            </div>
            ...
            <div className="flex items-center col-span-6">
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-[30px]">
                ...
                >
                  <div className="rounded-[10px] m-[1px] bg-white px-[26px] py-5 border border-transparent relative z-10 h-full">
