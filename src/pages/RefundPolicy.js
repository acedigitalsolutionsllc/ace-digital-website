      ...
      <section className="relative w-full pt-[150px] pb-[80px] bg-main-gray overflow-hidden">
        ...
        <div className="mx-auto theme-container relative z-10 text-center">
          ...
          <div className="flex justify-center items-center gap-2 text-paragraph font-medium">
            ...
            <span>/</span>
            <span className="text-purple">Refund Policy</span>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto theme-container max-w-4xl">
          ...
          <div data-aos="fade-up" className="bg-main-gray border border-[#e7e3fa] rounded-2xl p-8 mb-12 text-center shadow-sm">
            <p className="text-lg text-paragraph leading-relaxed">
              At <strong className="text-main-black">ACE Digital Solutions, LLC</strong>, we strive to provide high-quality AI-driven digital content, including AI Clone Avatar Videos, CGI Advertising, and Social Media Management. Due to the digital and highly customized nature of our services, we have established the following Refund Policy to ensure clarity and fairness for both parties.
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            <div data-aos="fade-up" className="pb-10 border-b border-[#e7e3fa]">
              ...
              <p className="text-paragraph ml-14">
                Because our services involve significant labor, computational power for AI processing, and creative custom work, <strong className="text-main-black bg-purple/10 px-2 py-0.5 rounded">all sales are generally final</strong>. Once the production or rendering process has begun for a specific project, we cannot offer a full refund.
              </p>
            </div>
            ...
            <div data-aos="fade-up" className="pb-10 border-b border-[#e7e3fa]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 ml-14">
                <div className="bg-main-gray p-6 rounded-xl border border-[#e7e3fa] hover:border-purple/30 transition-colors">
                  <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-purple shadow-sm mb-4">
                  ...
                  <h4 className="font-bold text-main-black mb-2">AI Clones & Video</h4>
                ...
                <div className="bg-main-gray p-6 rounded-xl border border-[#e7e3fa] hover:border-purple/30 transition-colors">
                  ...
                  <h4 className="font-bold text-main-black mb-2">Revision Policy</h4>
            ...
            <div data-aos="fade-up" className="pb-10 border-b border-[#e7e3fa]">
              ...
              <div className="ml-14 bg-[#f4f7ff] border border-[#c2d6ff] rounded-xl p-6">
                <ul className="space-y-4">
                  ...
                  <li className="border-t border-[#c2d6ff]/50 pt-4 text-[#1e3a8a]">
                    <strong className="block text-lg mb-1 flex items-center gap-2">
            ...
            <div data-aos="fade-up" className="pb-10 border-b border-[#e7e3fa]">
              <h3 className="text-2xl font-bold text-main-black mb-4 flex items-center gap-4">
                <span className="w-10 h-10 rounded-full bg-purple text-white flex items-center justify-center text-lg shadow-sm">5</span>
                Satisfaction Guarantee
              </h3>
              <p className="text-paragraph ml-14">
                Your satisfaction is our priority. If you are unhappy with a delivery, we encourage you to contact us immediately at <a href="mailto:info@aceavatars.com" className="text-purple font-medium hover:underline">info@aceavatars.com</a>. We will work closely with you to fix any issues, adjust the "Digital Persona," or provide an alternative solution that aligns with your vision.
              </p>
            </div>
            ...
            <div data-aos="fade-up" className="ml-14">
              <h3 className="text-2xl font-bold text-main-black mb-4 flex items-center gap-4">
                <span className="w-10 h-10 rounded-full bg-purple text-white flex items-center justify-center text-lg shadow-sm">6</span>
                Contact Us
              </h3>
