  ...
  return (
    <>
      ...
      <section className="relative w-full pt-[150px] pb-[80px] bg-main-gray overflow-hidden">
        ...
        <div className="mx-auto theme-container relative z-10 text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-[60px] font-bold text-main-black mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple to-blue-600">Earn the Reward.</span>
          </h1>
      ...
      <section className="w-full py-[80px] bg-white relative">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-purple/5 rounded-full blur-[100px] pointer-events-none"></div>

        <div className="mx-auto theme-container max-w-6xl relative z-10">
          
          {/* Rewards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-[80px]">
            <div data-aos="fade-up" className="bg-white border-2 border-[#e7e3fa] hover:border-purple rounded-[30px] p-10 text-center shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="text-5xl font-black text-main-black mb-2">15% <span className="text-2xl text-purple">OFF</span></div>
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="bg-purple rounded-[30px] p-10 text-center shadow-lg transform hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-full bg-white/5 pointer-events-none"></div>
              <div className="text-5xl font-black text-white mb-2 relative z-10">20% <span className="text-2xl text-[#8DC63F]">OFF</span></div>
          ...
          <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div data-aos="zoom-in" className="flex flex-col items-center">
                <div className="w-16 h-16 bg-purple/10 text-purple rounded-full flex items-center justify-center text-2xl font-black mb-4 border border-purple/20">1</div>
              ...
              <div data-aos="zoom-in" data-aos-delay="100" className="flex flex-col items-center relative">
                ...
                <div className="hidden md:block absolute top-8 -left-1/4 w-1/2 h-[2px] bg-dashed border-t-2 border-purple/20"></div>
                <div className="w-16 h-16 bg-purple/10 text-purple rounded-full flex items-center justify-center text-2xl font-black mb-4 border border-purple/20 relative z-10">2</div>
              ...
              <div data-aos="zoom-in" data-aos-delay="200" className="flex flex-col items-center relative">
                {/* Connecting Line for Desktop */}
                <div className="hidden md:block absolute top-8 -left-1/4 w-1/2 h-[2px] bg-dashed border-t-2 border-purple/20"></div>
                <div className="w-16 h-16 bg-purple text-white rounded-full flex items-center justify-center text-2xl font-black mb-4 shadow-md relative z-10">3</div>
          ...
          <div data-aos="fade-up" className="bg-white rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-[#e7e3fa] p-8 md:p-14">
            ...
            {status === "success" ? (
              <div className="text-center py-10">
                ...
                <button onClick={() => setStatus(null)} className="text-purple font-bold hover:underline">Submit Another Referral</button>
              </div>
            ) : (
              <form onSubmit={sendEmail} className="flex flex-col gap-6">
                ...
                <div className="bg-main-gray/30 p-6 rounded-2xl border border-[#e7e3fa]">
                  <h4 className="font-bold text-main-black mb-4 flex items-center gap-2">
                    <span className="text-purple"><svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></span>
                    Your Information
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-main-black mb-2">Your Full Name *</label>
                      <input type="text" name="referrerName" value={formData.referrerName} onChange={handleChange} required className="w-full h-[55px] px-5 bg-white border border-[#e7e3fa] focus:border-purple rounded-xl outline-none transition-all" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-main-black mb-2">Your Email *</label>
                      <input type="email" name="referrerEmail" value={formData.referrerEmail} onChange={handleChange} required className="w-full h-[55px] px-5 bg-white border border-[#e7e3fa] focus:border-purple rounded-xl outline-none transition-all" placeholder="john@yourcompany.com" />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-purple/5 p-6 rounded-2xl border border-purple/20">
                  <h4 className="font-bold text-main-black mb-4 flex items-center gap-2">
                    <span className="text-purple"><svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></span>
                    Referral's Information
                  </h4>
                  <div className="grid grid-cols-1 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-main-black mb-2">Referral's Full Name *</label>
                      <input type="text" name="referralName" value={formData.referralName} onChange={handleChange} required className="w-full h-[55px] px-5 bg-white border border-[#e7e3fa] focus:border-purple rounded-xl outline-none transition-all" placeholder="Jane Smith" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-main-black mb-2">Referral's Email or Phone *</label>
                      <input type="text" name="referralContact" value={formData.referralContact} onChange={handleChange} required className="w-full h-[55px] px-5 bg-white border border-[#e7e3fa] focus:border-purple rounded-xl outline-none transition-all" placeholder="jane@example.com OR (123) 456-7890" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-main-black mb-2">Additional Notes (Optional)</label>
                      <textarea name="notes" value={formData.notes} onChange={handleChange} rows="4" className="w-full p-5 bg-white border border-[#e7e3fa] focus:border-purple rounded-xl outline-none transition-all resize-none" placeholder="Tell us a bit about their business or how you know them..."></textarea>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full mt-4 py-4 bg-purple text-white font-bold text-lg rounded-xl hover:bg-main-black transition-all duration-300 disabled:bg-gray-400"
                >
