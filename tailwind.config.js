module.exports = {
  ...
  theme: {
    extend: {
      fontSize: {
        18: ["18px", { lineHeight: "27px", letterSpacing: "-0.03em" }],
        20: ["20px", { lineHeight: "30px", letterSpacing: "-0.03em" }],
        22: ["22px", { lineHeight: "30px", letterSpacing: "-0.03em" }],
        24: ["24px", { lineHeight: "35px", letterSpacing: "-0.03em" }],
        34: ["34px", { lineHeight: "44px", letterSpacing: "-0.03em" }],
        48: ["48px", { lineHeight: "56px", letterSpacing: "-0.03em" }],
        65: ["65px", { lineHeight: "70px", letterSpacing: "-0.03em" }],
        75: ["75px", { lineHeight: "85px", letterSpacing: "-0.03em" }],
        pone: ["16px", "30px"],
        ptwo: ["16px", "26px"],
      },
      fontFamily: {
        inter: ["Inter", "sans-serif"],
        // --- ACE Digital Brand Fonts ---
      ...
      colors: {
        ...
        // --- ACE Digital Brand Colors ---
        'ace-green': '#8DC63F',
        'ace-dark': '#111428',
        'ace-card-bg': '#1B1F3B',
        'ace-text': '#475569', // Modern Light Theme Text
        'ace-bg': '#F8FAFC',   // Premium Off-white background
        'ace-light': '#ffffff',
        'ace-gray': '#B0B3C6',
      },
      boxShadow: {
        ...
        // --- ACE Digital Premium Shadows ---
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.05)', // For glassmorphism effects
        'glow': '0 0 25px rgba(141, 198, 63, 0.3)',      // For glowing buttons
      },
    },
  },
  plugins: [],
